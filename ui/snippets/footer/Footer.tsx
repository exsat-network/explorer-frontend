  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      iconSize: '18px',
      text: 'Telegram',
      url: 'https://t.me/ExSatNetwork',
    },
{
      icon: 'social/twitter' as const,
      iconSize: '18px',
      text: 'X (ex-Twitter)',
      url: 'https://x.com/exsatnetwork',
    },
    {
      icon: 'docs' as const,
      iconSize: '18px',
      text: 'Docs',
      url: 'https://docs.exsat.network',
    },
    {
      icon: 'social/git' as const,
      iconSize: '18px',
      text: 'Contribute',
      url: 'https://github.com/exsat-network/blockscout',
    },
    {
      icon: 'social/medium_filled' as const,
      iconSize: '18px',
      text: 'Medium',
      url: 'https://medium.com/exsat-network',
    },
  ];
